...
const DashboardHome = () => {
  return (
    <div>
      ...
      <div
        className="position-relative mb-4 rounded-3 overflow-hidden shadow-sm"
        style={{ height: "300px" }}
      >
        <img
          src="https://images.unsplash.com/photo-1560626184-524744344bef?q=80&w=1233&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Mosque"
        ...
        >
          <h2 className="text-white fw-bold">
            Selamat Datang, Masjid Al-Furqon
          </h2>
